    ...
    return (<EdContents>
        ...
        <ul>
            <div className="college-education">
                ...
                <StyledImage>
                <img className="logo" src="../components/public/bu_logo.png" alt="Boston University Logo"/>
                </StyledImage>
            </div>
        </ul>
        <ul>
            <div className="college-education">
                ...
                <StyledImage>
                <img className="logo" src="../components/public/ulc_next.webp" alt="Uncommon Leadership Logo"/>
                    </StyledImage>
                </div>
        </ul>
